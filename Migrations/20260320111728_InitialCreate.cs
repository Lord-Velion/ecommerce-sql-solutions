    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GoodProperties_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodProperties_Goods_GoodId",
                        column: x => x.GoodId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderDetail_GoodCount", "GoodCount > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodProperties_ColorId",
                table: "GoodProperties",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodProperties_GoodId",
                table: "GoodProperties",
                column: "GoodId");
